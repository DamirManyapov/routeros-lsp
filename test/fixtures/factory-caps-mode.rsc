# RouterOS factory CAP-mode configuration, from the same source.
#
# Notable for a string literal that runs across lines with no continuation
# marker — a form RouterOS accepts and its own configuration relies on.
