# RouterOS factory default configuration, as returned by
# /system/default-configuration on a hAP ax^2 running 7.20.8.
#
# Written by MikroTik and identical on every unit of the model, so it carries
# nothing specific to any device. It is here because it is real: hand-written
# fixtures never contain the constructs that actually break a parser.
